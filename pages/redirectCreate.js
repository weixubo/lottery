...
var _createClass = function() {
    ...
    return _inherits(t, e), _createClass(t, [ {
        key: "onShow",
        value: function() {
            this.back ? (this.back = !1, _wepy2.default.switchTab({
                url: this.$parent.globalData.prevTab
...
Page(require("./../npm/wepy/lib/wepy.js").default.$createPage(Index, "pages/redirectCreate"));