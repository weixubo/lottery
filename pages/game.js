...
var _createClass = function() {
    ...
    return _inherits(t, e), _createClass(t, [ {
        key: "onLoad",
        value: function(e) {
            var t = "/pages/lottery/pages/game?";
            e.id && (t += "id=" + e.id + "&"), e.scene && (t += "scene=" + e.scene + "&"), _wepy2.default.redirectTo({
                url: t.slice(0, -1)
            });
        }
    } ]), t;
...
Page(require("./../npm/wepy/lib/wepy.js").default.$createPage(Index, "pages/game"));