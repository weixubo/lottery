...
}(), _square = require("./../services/square.js"), GameService = _interopRequireWildcard(_square), _ListManager2 = require("./ListManager.js"), _ListManager3 = _interopRequireDefault(_ListManager2), _GameManager = require("./GameManager.js"), _GameManager2 = _interopRequireDefault(_GameManager), PublicSquareManager = function(e) {
    function r() {
            ...
            var r = _asyncToGenerator(regeneratorRuntime.mark(function e(r) {
                return regeneratorRuntime.wrap(function(e) {
                    for (;;) switch (e.prev = e.next) {
                      case 0:
                        return e.abrupt("return", GameService.publicSquareList(r));
...
}(_ListManager3.default), squareManager = new PublicSquareManager();
