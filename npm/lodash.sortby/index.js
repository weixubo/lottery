...
function baseMap(e, t) {
    var r = -1, a = isArrayLike(e) ? Array(e.length) : [];
...
function baseOrderBy(e, t, r) {
    var a = -1;
    return t = arrayMap(t.length ? t : [ identity ], baseUnary(baseIteratee)), baseSortBy(baseMap(e, function(e, r, n) {
        return {
...
function compareAscending(e, t) {
    if (e !== t) {
        var r = void 0 !== e, a = null === e, n = e === e, o = isSymbol(e), s = void 0 !== t, i = null === t, c = t === t, u = isSymbol(t);
        if (!i && !u && !o && e > t || o && s && c && !i && !u || a && s && c || !r && c || !n) return 1;
        if (!a && !o && !u && e < t || u && r && n && !a && !o || i && r && n || !s && n || !c) return -1;
    }
    return 0;
}

function compareMultiple(e, t, r) {
    for (var a = -1, n = e.criteria, o = t.criteria, s = n.length, i = r.length; ++a < s; ) {
        var c = compareAscending(n[a], o[a]);
        if (c) {
            if (a >= i) return c;
...
function equalObjects(e, t, r, a, n, o) {
    ...
    if (f && !p) {
        var d = e.constructor, T = t.constructor;
        d != T && "constructor" in e && "constructor" in t && !("function" == typeof d && d instanceof d && "function" == typeof T && T instanceof T) && (f = !1);
    }
...
}), sortBy = baseRest(function(e, t) {
    if (null == e) return [];
    var r = t.length;
    return r > 1 && isIterateeCall(e, t[0], t[1]) ? t = [] : r > 2 && isIterateeCall(t[0], t[1], t[2]) && (t = [ t[0] ]), 
