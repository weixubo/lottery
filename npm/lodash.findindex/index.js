...
function baseIsEqualDeep(e, t, r, a, n, o) {
    ...
    var l = c == objectTag && !isHostObject(e), f = u == objectTag && !isHostObject(t), y = c == u;
    if (y && !l) return o || (o = new Stack()), s || isTypedArray(e) ? equalArrays(e, t, r, a, n, o) : equalByTag(e, t, c, r, a, n, o);
    if (!(n & PARTIAL_COMPARE_FLAG)) {
        var p = l && hasOwnProperty.call(e, "__wrapped__"), g = f && hasOwnProperty.call(t, "__wrapped__");
        if (p || g) {
...
function baseIsMatch(e, t, r, a) {
    ...
    for (;++n < o; ) {
        ...
        if (s && i[2]) {
            ...
            var f = new Stack();
            if (a) var y = a(u, l, c, e, t, f);
            if (!(void 0 === y ? baseIsEqual(l, u, a, UNORDERED_COMPARE_FLAG | PARTIAL_COMPARE_FLAG, f) : y)) return !1;
        }
    }
    return !0;
}
